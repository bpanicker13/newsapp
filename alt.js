...
$(document).ready(function() {
	...
	// Init starting category (world)
	$("#world").css("background", "darkseagreen");
...
var BASE_URL_END = ".json?api-key=a4eeb58e373e4d96b96e5bcc9667cf61";
...
var setupForceLayout = function(stories) {
	...
	// Prevent following link on circle nodes, change side card, highlight node
...
var setBackground = function() {
	$("body").css("background", 'url("wet_snow.jpg")');
	$(".pusher").css("background", 'url("wet_snow.jpg")');
};
